...
One naming note up front: the product is **Talkak** (the bundle's `productName`), the repo is `ddalkkak`, user-facing data directories use `DalkkakAI`, and the tmux socket is `dalkkak`. Same project, four layers of naming history.
