...
Save this as `docs/troubleshooting.md`:
...
Paste this block into your project's `CLAUDE.md` (create the file if it doesn't exist):
...
Save this as `.claude/settings.json` (or merge with your existing one — don't overwrite if you have other settings):
...
This site uses exactly this setup. Source: <a href="https://github.com/Daeseon-AI-Factory/daseon-blog" target="_blank" rel="noopener noreferrer">github.com/Daeseon-AI-Factory/daseon-blog</a>. The portable spec lives at `docs/project-log-spec.md` in that repo. Live timeline demo: <a href="/projects/daeseon-ai">/projects/daeseon-ai</a>.
