...
const COPY: Record<Locale, StringDict> = {
  en: {
    ...
    "nav.method": "Method",
    "wiki.heading": "Wiki",
    "wiki.subtitle": "Engineering fundamentals — the principle underneath, the tools that are just instances of it, and the buzzwords that bury it.",
    "wiki.empty": "No entries yet.",
    "wiki.instances": "Instances",
    "home.heading": "Notes",
    "home.empty": "No posts yet.",
    "post.readingTime": "min read",
    "post.translation": "한국어 버전 →",
    "post.handwritten": "By hand",
  ...
  ko: {
    ...
    "nav.method": "방법론",
    "wiki.heading": "위키",
    "wiki.subtitle": "엔지니어링 기본 원리 — 그 아래의 원리, 그것의 사례일 뿐인 도구들, 그리고 그걸 묻어버리는 buzzword.",
    "wiki.empty": "아직 항목이 없습니다.",
    "wiki.instances": "사례",
    "home.heading": "글",
